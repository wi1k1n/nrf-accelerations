...
@register_model('mlnrfexbf')
class MLNRFExBFModel(MLNRFExModel):
	READER = 'image_reader'
	ENCODER = 'sparsevoxel_light_encoder'
	FIELD = 'radiance_explicit_light_field'
	RAYMARCHER = 'light_bruteforce_volume_renderer'
...
@register_model_architecture("mlnrfexbf", "mlnrfexbf_base")
