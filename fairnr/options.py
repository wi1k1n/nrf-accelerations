...
def add_rendering_args(parser):
    ...
    group.add_argument("--render-path-style", default="circle", choices=["circle", "zoomin_circle", "zoomin_line", "drunk"], type=str)
    ...
    group.add_argument("--render-output-types", nargs="+", type=str, default=["color"], 
                        choices=["target", "color", "depth", "normal", "normal_brdf", "voxel", "predn", "point", "featn2", "vcolors", "hdrflip"])
    ...
    group.add_argument("--render-light-path-style", default="circle", choices=["circle", "zoomin_circle", "zoomin_line", "drunk"], type=str)
