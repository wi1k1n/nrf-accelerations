...
MIN_COLOR = '0.0'  #
MAX_COLOR = '0.8'  # 0.8 - rocket/guitar/lego; 5.0 - sphere; 0.3 - drums
GAMMA_CORRECTION = '1.0'  # 2.0 - rocket/guitar/drums; 1.0 - sphere/lego;
...
# LIGHT_INTENSITY = '500.0'  # rocket_exr -> 5k Watt
# LIGHT_INTENSITY = '350.0'  # tablelamp_exr -> 0.5k Watt
# LIGHT_INTENSITY = '100.0'  # guitar_exr -> 0.5k Watt
