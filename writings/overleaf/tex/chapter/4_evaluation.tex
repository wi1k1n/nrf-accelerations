...
The \textit{ExCol} scheme similar to \textit{ExBF} results,
...
It can be clearly seen that \textit{ImNRF} trained on colocated light dataset,
...
Same tendency as in \Cref{tab:arb_selective_results} can be noticed
