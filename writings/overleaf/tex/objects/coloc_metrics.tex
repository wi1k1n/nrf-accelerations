...
\begin{table*}[!htb]
    ...
    \begin{tabular*}{\textwidth}{ l | l | c c c c | c c c }
        ...
        % & ExVA & \textbf{30.52} & 0.950 & 0.061 & 0.050 & 150k & 256px & 14h \\
        ...
        \multirow{3}{*}{Hotdog}
        & ExCol & \textbf{32.80} & \textbf{0.96} & \textbf{0.040} & 0.075 & 70k & 256px & 6h \\
        & ExVA & 32.57 & 0.96 & 0.040 & \textbf{0.073} & 70k & 256px & 25h$^*$ \\
