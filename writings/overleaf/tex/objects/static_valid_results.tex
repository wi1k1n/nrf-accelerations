...
\begin{figure}[!htb]
    ...
    \begin{tabular*}{0.85\textwidth}{ c c c c c c }
        ...
        \setlength\tabcolsep{0pt}
        \begin{tabular}{cc}
            \includegraphics[width=0.07\textwidth]{figures/results/stat_set/valid/guitar4_exva_depth_89k.png} & \includegraphics[width=0.07\textwidth]{figures/results/stat_set/valid/guitar8_exva_depth_89k.png}
        \end{tabular}
        &
        \setlength\tabcolsep{0pt}
        \begin{tabular}{cc}
            \includegraphics[width=0.07\textwidth]{figures/results/stat_set/valid/guitar4_exva_voxel_89k.png} & \includegraphics[width=0.07\textwidth]{figures/results/stat_set/valid/guitar8_exva_voxel_89k.png}
        \end{tabular} \\[-5pt]
        ...
        \setlength\tabcolsep{0pt}
        \begin{tabular}{cc}
            \includegraphics[width=0.07\textwidth]{figures/results/stat_set/valid/guitar4_nsvf_depth_119k.png} & \includegraphics[width=0.07\textwidth]{figures/results/stat_set/valid/guitar8_nsvf_depth_119k.png}
        \end{tabular}
        &
        \setlength\tabcolsep{0pt}
        \begin{tabular}{cc}
            \includegraphics[width=0.07\textwidth]{figures/results/stat_set/valid/guitar4_nsvf_voxel_119k.png} & \includegraphics[width=0.07\textwidth]{figures/results/stat_set/valid/guitar8_nsvf_voxel_119k.png}
        \end{tabular} \\[0pt]
